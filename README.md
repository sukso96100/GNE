...
* `Call Trace`는 정보가 투명하게 표시되므로 안보에 문제가 있습니다. `제가 뭐라고 했습니까?`가 안보 경고가 발령됩니다.
...
```
* 감청할 수 없는 지메일을 사용하는 모든 사람들은 종북세력입니다. 대신, GDP에 기여할 수 있는 샵메일을 쓰십시오. 코드에 지메일이 존재할 시 안보 경고가 발령됩니다.
```
안보 경고: 지메일을 사용하는 사람은 종북세력입니다. 믿을 수 있는 샵메일을 대신 사용사십시오.
```
