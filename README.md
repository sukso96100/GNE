...
해당 런타임은 실행을 위해 독일에 위치한 서버에서 허가를 받아야 합니다. 독일 저녁이 되는 시간(UTC +2)에는 잠들기 때문에 GNE로 만든 사회는 작동하지 않습니다. 승인에 독일과의 시차 7시간이 걸리더라도 놀라지 마세요 : )
...
### 8선녀회 멀티 프로세스
SSVM은 8개의 멀티프로세스를 활용하여 고성능의 연산을 할 수 있습니다.
